...
import { MapPinIcon, Mail, Lock, Eye, EyeOff } from "lucide-react"
      ...
      >
        <div className="h-full w-full bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-md p-8 text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Find Rural Jobs Near You</h2>
            <p className="mb-6">Connect with opportunities in rural communities and discover your next career move.</p>
            <Link href="/jobs">
