...
import { MapPinIcon, Mail, Lock, User, Eye, EyeOff } from "lucide-react"
      ...
      >
        <div className="h-full w-full bg-black bg-opacity-50 flex items-center justify-center">
          <div className="max-w-md p-8 text-white text-center">
            <h2 className="text-3xl font-bold mb-4">Join the Rural Renaissance</h2>
            <p className="mb-6">
              Create an account to save job searches, receive personalized alerts, and apply with a single click.
            </p>
            <Link href="/jobs">
